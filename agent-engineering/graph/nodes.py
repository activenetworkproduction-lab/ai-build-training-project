...
#
# 实测效果：主题"RAG（检索增强生成）"，研究员产出4条要点，写手基于要点写出草稿，
# 评论者第一轮就给出 APPROVE（"隐喻生动、逻辑层层递进"），0 次修改就结束——
# 说明质量把关到位时图不一定要经过环路。REVISE 打回写手、状态携带反馈、
# MAX_REVISIONS 强制终止这几个环路机制，用模拟的"永远要求修改"评论者单独测试过，
# 3 轮后正确停止，不会死循环。
#
# import requests
#
